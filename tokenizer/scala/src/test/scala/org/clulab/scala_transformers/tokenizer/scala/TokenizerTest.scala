...
class TokenizerTest extends Test {
  ...
  it should "tokenize with the distilbert-base-cased tokenizer" in {
    val tokenizer = ScalaTokenizer("distilbert-base-cased")
  ...
  it should "tokenize with the bert-base-cased tokenizer" in {
    val tokenizer = ScalaTokenizer("bert-base-cased")
    val tokenization = tokenizer.tokenize(words)
  ...
  it should "tokenize with the xlm-robert-base tokenizer" in {
    val tokenizer = ScalaTokenizer("xlm-roberta-base")
    val tokenization = tokenizer.tokenize(words)
  ...
  it should "tokenize with the roberta-base tokenizer with addPrefixSpace = true" in {
    val tokenizer = ScalaTokenizer("roberta-base", addPrefixSpace = true)
    val tokenization = tokenizer.tokenize(words)
  ...
  ignore should "tokenize with the roberta-base tokenizer with addPrefixSpace = false" in {
    val tokenizer = ScalaTokenizer("roberta-base", addPrefixSpace = false)
    val tokenization = tokenizer.tokenize(words)
  ...
  it should "tokenize with the microsoft/deberta-v3-base tokenizer" in {
    val tokenizer = ScalaTokenizer("microsoft/deberta-v3-base", addPrefixSpace = false)
    val tokenization = tokenizer.tokenize(words)
