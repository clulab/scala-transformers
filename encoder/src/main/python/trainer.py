...
def main():
  ...
  depl_task = Task(4, "Deps Label", "data/deps-wsj/train.labels", "data/deps-wsj/dev.labels", "data/deps-wsj/test.labels", tokenizer)
  ...
  for epoch in range(1, cf.epochs + 1):
    ...
    save_stats("epoch_stats.txt", tasks, [ner_acc, pos_acc, chunk_acc, deph_acc, depl_acc], macro_acc, epoch)
