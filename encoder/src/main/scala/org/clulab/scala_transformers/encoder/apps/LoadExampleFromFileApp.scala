...
import org.clulab.scala_transformers.encoder.{Encoder, ModelLayout, ModelReaderFromFiles, TokenClassifier}
...
object LoadExampleFromFileApp extends App {
  ...
  val encoder = Encoder.fromFile(modelLayout.getModel)
